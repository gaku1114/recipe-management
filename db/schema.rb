...
ActiveRecord::Schema.define(version: 2023_03_04_122536) do
  ...
  create_table "cooks", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["dish_id"], name: "index_cooks_on_dish_id"
  end
  ...
  create_table "materials", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["dish_id"], name: "index_materials_on_dish_id"
  end
  ...
  add_foreign_key "cooks", "dishes"
  add_foreign_key "dishes", "genres"
  add_foreign_key "genres", "users"
  add_foreign_key "materials", "dishes"
end
